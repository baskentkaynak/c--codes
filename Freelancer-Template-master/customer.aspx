...
<body>
  ...
  <div class="container-fluid">
    ...
    <div>
    <asp:GridView ID="GridView1" runat="server" CssClass="table" AllowPaging="True" AllowSorting="True" DataSourceID="SqlDataSource1"  AutoGenerateColumns="False" DataKeyNames="customerID" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" EnablePersistedSelection="True" EnableSortingAndPagingCallbacks="True" >
        <Columns>
            
            
             <asp:CommandField ShowDeleteButton="True" ShowInsertButton="False"  InsertVisible="true"  ShowEditButton="True" ButtonType="Button" EditText="Değiştir" DeleteText="Sil" CancelText="Vazgeç" UpdateText="Değiştir"  ControlStyle-CssClass="btn-toolbar" >

<ControlStyle CssClass="btn-toolbar"></ControlStyle>
             </asp:CommandField> 
            ...
            <asp:BoundField DataField="authorizedName" HeaderText="İsim" SortExpression="authorizedName" InsertVisible="true" />
